...
urlpatterns = [
    ...
    path('team/<team_id>/analysis/vp/', views.view_volume_profile_analysis, name='cfd_profile_analysis_vp_view'),
    ...
    path('team/<team_id>/analysis/vp/add/', views.add_volume_profile_analysis, name='cfd_profile_analysis_vp_add'),
    ...
    path('analysis/vp/<int:analysis_id>/edit', views.volume_profile_analysis_edit, name='cfd_profile_analysis_vp_edit'),
    ...
    path('analysis/vp/<int:analysis_id>/delete', views.volume_profile_analysis_delete, name='cfd_profile_analysis_vp_delete'),
