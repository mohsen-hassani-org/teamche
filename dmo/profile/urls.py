...
urlpatterns = [
    path('this-month/', views.all_public_dmos, name="dmo_profile_dmo_view_this_month"),
    # path('this-month/', views.view_my_this_month_dmos, name="dmo_profile_dmo_view_this_month"),
    path('all/', views.view_my_all_dmos, name="dmo_profile_dmo_view_all"),
    path('add/', views.add_dmo, name="dmo_profile_dmo_add"),
